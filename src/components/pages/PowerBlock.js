...
import {powerBlockHome, makeIndia, swachhBharat,powerDescription,powerLinks,client1,client2 } from './../data';
  ...
  return (
    <div className="app-container">
      ...
      <div className="logo-row">
        ...
        <div className="logo-item">
          <img src={powerBlockHome.logo} alt="Carry Bag Logo" className="image-category" />
          <p>{powerBlockHome.name}</p>
        </div>
        <div className="logo-item">
    ...
    <h2>Description</h2>
      ...
      <ReadMore text={powerDescription} style={{
            fontSize: '18px', 
            fontWeight: '400', 
            marginLeft: '25px', 
            marginRight: '25px', 
