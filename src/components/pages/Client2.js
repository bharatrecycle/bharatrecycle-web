...
import {client1 ,client2description , client2Links ,client2,makeIndia, swachhBharat} from './../data';
...
const Client2 = () => {
    ...
    return (
        ...
        <div className="logo-row">
          ...
          <div className="logo-item">
            <img src={client2.logo} alt="Carry Bag Logo" className="image-category" />
            <p>{client2.name}</p>
          </div>
          <div className="logo-item">
        ...
        <h2>Description</h2>
        <ReadMore text={client2description} className="category-desc" style={{
                fontSize: '18px', 
                fontWeight: '400', 
                marginLeft: '25px', 
                marginRight: '25px', 
