...
import {client1 ,client1description , client1Links ,client2,makeIndia, swachhBharat} from './../data';
...
const Client1 = () => {
    ...
    return (
        ...
        <div className="logo-row">
          ...
          <div className="logo-item">
            <img src={client1.logo} alt="Carry Bag Logo" className="image-category" />
            <p>{client1.name}</p>
          </div>
          <div className="logo-item">
        ...
        <h2>Description</h2>
        <ReadMore text={client1description} className="category-desc" style={{
                fontSize: '18px', 
                fontWeight: '400', 
                marginLeft: '25px', 
                marginRight: '25px', 
